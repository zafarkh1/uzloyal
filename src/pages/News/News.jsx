  ...
  return (
    <div className="flex justify-center min-h-screen mt-20">
      ...
      <div className="flex w-full">
        {/* Sidebar */}
        <div className="w-[30%] px-4 mr-4 flex flex-col"> {/* Adjusted margin-right */}
          <div className="mb-20"> {/* Spacing for BlogSidebarCard */}
            <BlogSidebarCard />
          </div>
          <div className="mb-20"> {/* Spacing for PostSideBarCard */}
            <PostSideBarCard />
          </div>
        </div>
                ...
                <div className="entry-meta mb-4">
                  <ul>
                    <li className="flex items-center text-gray-500">
                      <i className="fi flaticon-user mr-2"></i> By <span>{post.author}</span>
                    </li>
                    <li className="flex items-center text-gray-500">
