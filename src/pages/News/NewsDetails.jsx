...
import { useParams, useNavigate, Link } from 'react-router-dom'; // Use useNavigate instead of useHistory
import BlogSidebarCard from '../Cards/BlogSideBarCard'; // Sidebar component
...
const NewsDetails = () => {
  ...
  const posts = [
    { id: 1, title: 'Citizens allowed to cross Kyrgyz-Uzbek border with an ID card', author: 'Sarvarjon Amriyev', date: '2023-12-05', imageUrl: 'https://test.uzloyal.uz/api/uploads/images/64e4d722-8425-4afd-8db1-e8220e16da1c.jpeg' },
    { id: 2, title: 'Бу йил Ўзбекистонда қандай қиш кутилмоқда? – иқлимшунос билан интервю', author: 'Sherali Jo\'rayev', date: '2023-12-07', imageUrl: 'https://test.uzloyal.uz/api/uploads/images/98026dbe-25f8-4d76-b52e-e258796477c4.jpeg' },
    { id: 3, title: 'New tariffs to be introduced in Tashkent public transport', author: '', date: '2023-12-05', imageUrl: 'https://test.uzloyal.uz/api/uploads/images/3b538972-d020-498f-8be7-61b4fd764557.jpeg' },
    { id: 4, title: '«Бахти Ташкентский» 15 суткага қамалди', author: '', date: '2023-12-06', imageUrl: 'https://test.uzloyal.uz/api/uploads/images/15ac793c-ed2f-4ae2-adbd-f66089226b6d.jpeg' },
    { id: 5, title: 'Bakhtiyor Saidov and David Cameron', author: 'Sarvarjon Amriyev', date: '2023-12-05', imageUrl: 'https://test.uzloyal.uz/api/uploads/images/84974d67-53db-4bdc-a668-b90fab3576b2.jpeg' },
  ];
              ...
              <div className="entry-meta">
                <ul className="flex space-x-4 items-center justify-start">
                  <li className="flex items-center">
                    ...
                    <span>By </span>
                    <Link to={`/newsdetails/${currentPost.id}`} className="ml-1 hover:text-[#c3af41]">
                      {currentPost.author}
                    </Link>
                  </li>
                  <li className="flex items-center">
              ...
              <div className="more-posts flex justify-between w-[800px] ml-0 mt-10 mb-10">
                {prevPost && (
                  <div className="previous-post border border-gray-300 p-4 flex flex-col">
                    <button onClick={handlePreviousClick} className="flex flex-col items-start">
